---
title: "magic API 文档"
description: "面向开发者的 magic API 文档入口，覆盖文本、图像、视频、上传、任务和账户能力。"
---

# magic API 文档

这套文档面向接入 magic API 的开发者，汇总可公开调用的能力、鉴权方式、参数说明、响应格式和异步任务流程。

文档只说明开发者调用 magic API 时需要关注的公开 API 行为与使用约定。
