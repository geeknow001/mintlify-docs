...
| MiniMax H3 | `MiniMax-H3`（兼容 `minimax-h3` 历史名称） | [概览](/api-reference/videos/minimax-h3/overview) | `/v1/videos` | 文生视频、首帧、尾帧、首尾帧、参考图片、参考视频、参考音频 | JSON `content[]`；固定 `768P`，`duration` 为 1-15 秒 |
