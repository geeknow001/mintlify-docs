---
title: 视频模型支持矩阵
description: 汇总当前视频模型系列的推荐入口、生成模式、参考素材传递方式和时长限制。
---

# 视频模型支持矩阵

这张表汇总当前视频模型系列的主入口、常见模式和参考素材传递方式。
...
| Grok Imagine | `grok-imagine-video`、`grok-imagine-video-1.5-preview` | [概览](/api-reference/videos/grok/overview) | `/v1/videos` | 文生视频、图生视频、参考图视频 | JSON `image` / `images`；参考图最多 `7` 张，1.5 Preview 使用 `images` |
...
| MiniMax H3 | `minimax-h3-768p`、`minimax-h3-2k`、`minimax-h3-pro-768p`、`minimax-h3-pro-2k` | [概览](/api-reference/videos/minimax-h3/overview) | `/v1/videos` | 文生视频、图生视频、首尾帧、参考音频、Pro 参考视频 | JSON `referenceImages` / `first_image` / `last_image` / `referenceAudios` / `referenceVideos`；普通档是 `503`，Pro 档是 `913` |
| manxue-2.5 | `manxue-2.5` | [概览](/api-reference/videos/manxue-2.5/overview) | `/v1/videos` | 仅参考生视频 | JSON `model` / `prompt` / `seconds` / `ratio` / `images`；参考图必填，最多 `30` 张 |
| mini-2.0 | `mini-2.0` | [概览](/api-reference/videos/mini-2.0/overview) | `/v1/videos` | 文生视频、参考图生视频 | JSON `model` / `prompt` / `duration` / `ratio` / `resolution` / `images`；参考图最多 `9` 张 |
| Wan 3.0 | `wan3.0-video`、`wan3.0-video-prime` | [概览](/api-reference/videos/wan3/overview) | `/v1/videos` | 文生视频、首帧、首尾帧、多图参考、参考视频、参考音频 | JSON `image` / `images` / `input_reference` / `metadata`；高级场景可用原生 `input.media` |
...
| 特惠渠道系列 | `manxue-2.0` | [概览](/api-reference/videos/special-offer/overview) | `/v1/videos` | 文生视频、首帧生视频、首尾帧、参考图、参考音频 | JSON `content[].image_url` / `content[].audio_url` |
| Seedance 2.0 | `doubao-seedance-2-0-260128`、`doubao-seedance-2-0-fast-260128` | [概览](/api-reference/videos/seedance-2/overview) | `/v1/videos` | 文生视频、首帧、尾帧、参考图、参考视频、参考音频 | JSON URL 字段 |
| Seedance 1.5 | `doubao-seedance-1-5-pro_480p`、`doubao-seedance-1-5-pro_720p`、`doubao-seedance-1-5-pro_1080p` | [概览](/api-reference/videos/seedance/overview) | `/v1/videos` | 文生视频、首帧生视频、首尾帧 | multipart URL 字段 |
...
| 推荐入口 | `POST /v1/videos` |
| 文档页面 | [MiniMax H3 视频概览](/api-reference/videos/minimax-h3/overview) |
...
| 模型示例 | `manxue-2.5` |
| 推荐入口 | `POST /v1/videos` |
| 文档页面 | [manxue-2.5 视频概览](/api-reference/videos/manxue-2.5/overview) |
...
| 模型示例 | `mini-2.0` |
| 推荐入口 | `POST /v1/videos` |
| 文档页面 | [mini-2.0 视频概览](/api-reference/videos/mini-2.0/overview) |
| 请求格式 | `application/json` |
...
| 推荐入口 | `POST /v1/videos` |
| 文档页面 | [概览](/api-reference/videos/wan3/overview) |
...
| 模型示例 | `manxue-2.0` |
| 推荐入口 | `POST /v1/videos` |
| 文档页面 | [特惠渠道系列概览](/api-reference/videos/special-offer/overview) |
...
| 推荐入口 | `POST /v1/videos` |
| 文档页面 | [Seedance 2.0 概览](/api-reference/videos/seedance-2/overview) |
...
| 推荐入口 | `POST /v1/videos` |
| 文档页面 | [Seedance 1.5 概览](/api-reference/videos/seedance/overview) |
...
2. [MiniMax H3 视频概览](/api-reference/videos/minimax-h3/overview)
3. [manxue-2.5 视频概览](/api-reference/videos/manxue-2.5/overview)
4. [mini-2.0 视频概览](/api-reference/videos/mini-2.0/overview)
5. [Wan 3.0 视频概览](/api-reference/videos/wan3/overview)
6. [Omni 视频模型概览](/api-reference/videos/omni/overview)
7. [Veo 视频概览](/api-reference/videos/veo/overview)
8. 如果你要做图生视频，先确认目标模型需要的是 `image`、`images`、`input_reference`、`referenceImages` 还是 `first_frame_image` / `last_frame_image`。
9. 如果你明确是 Kling 官方格式接入，再看 `/kling/v1/videos/*` 这一组路由。
