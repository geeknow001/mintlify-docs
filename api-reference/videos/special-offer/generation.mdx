---
title: manxue-2.0 视频生成
description: 使用 `POST /v1/videos` 调用 `manxue-2.0` 提交 JSON 视频生成任务。
api: "POST /v1/videos"
---
...
func main() {
	...
	req, _ := http.NewRequest("POST", "https://magic666.top/v1/videos", bytes.NewReader(body))
