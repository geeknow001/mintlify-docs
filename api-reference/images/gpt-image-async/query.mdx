---
title: 图像异步任务查询
description: 使用 `GET /v1/images/generations/async/{taskId}` 查询图像异步生成任务状态、进度和结果。
...
```bash cURL
curl -X GET https://magic666.top/v1/images/generations/async/task_img_abc123 \
...
resp = requests.get(
    f"https://magic666.top/v1/images/generations/async/{task_id}",
...
const response = await fetch(
  `https://magic666.top/v1/images/generations/async/${taskId}`,
  {
    method: "GET",
    headers: {
