...
```bash
curl -X POST https://magic666.top/v1/images/edits \
...
with open("input.png", "rb") as f:
    resp = requests.post(
        "https://magic666.top/v1/images/edits",
...
const response = await fetch("https://magic666.top/v1/images/edits", {
  method: "POST",
  headers: {
...
```bash
curl -X POST https://magic666.top/v1/edits \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -F "model=gpt-image-1" \
...
- [OpenAI Images 兼容图像生成](./generation)
