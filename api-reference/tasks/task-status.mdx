...
```bash
curl https://magic666.top/v1/video/generations/task-video-abc123 \
...
resp = requests.get(
    "https://magic666.top/v1/video/generations/task-video-abc123",
...
```bash
curl https://magic666.top/v1/videos/task-video-abc123 \
  -H "Authorization: Bearer YOUR_API_KEY"
```
